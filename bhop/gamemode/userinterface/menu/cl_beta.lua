...
local description = {[1] = "Welcome to Beta Options!",[2] = "You can enable experimental stuff by clicking on the tabs above",[3] = "Note that some features may not work properly",[5] = "New Features",[6] = "You can toggle between the old and new centerspeed",[7] = "You can show true player usernames' tab",[8] = "You can toggle command hints"}
local notifychange = {[1] = "This setting requires you to rejoin the server"}
local simpleNetGraphOptions = {[1] = "Top Right",[2] = "Top Left",[3] = "Bottom Left",[4] = "Button Right"}
local interfaceScaleOptions = {[1] = "Small",[2] = "Large"}
...
function DevTools:Open()
	...
	panel = SMPanels.MultiHoverFrame( { title = "Beta Menu " .. "v" .. DevTools.Version, subTitle = "", center = true, w = size[1], h = size[2], pages = { "About", "Client", "Server" } } )
	...
	do
		...
		function DevTools.ChangeNetgraphPosition( int )
			...
			Link:Print( "Timer", "Your Netgraph Position has been moved towards the " .. netgraphValue )
		end
		...
		function DevTools.ChangeInterfaceScaleSize(int)
			...
			Link:Print( "Timer", "Your Interface Scale size has been set to " .. interfaceScaleValue )
		end
		...
		SMPanels.EndList( { parent = panel.Pages[2], text = "", x = bezel, y = bezel + ( padSize * 11 ), convar = "sl_customchat", tip = "Displays command listings and descriptions when typing out chat commands" } )
