-- Core Includes
AddCSLuaFile "modules/fpsfixes/cl_buffthefps.lua"
include "shared.lua"
include "essential//timer_lang.lua"
include "essential/timer_data.lua"

-- Server Includes
include "sv_player.lua"
include "sv_command.lua"
include "essential/timer/sv_timer.lua"
include "essential/zones/sv_zones.lua"

-- Module Includes
local modules = {
    "fpsfixes/sv_disablehooks.lua",
    "fpsfixes/cl_nixthelag.lua",
    "fpsfixes/cl_buffthefps.lua",
    "fpsfixes/sh_serialization.lua",
    "sv_rtv.lua",
    "admin/sv_admin.lua",
    "sv_bot.lua",
    "sv_spectator.lua",
...
local function UpdatePlayerPosition(player)
    ...
    if not lastUpdateTimes[player] or curTime - lastUpdateTimes[player] > 0.0167 then
