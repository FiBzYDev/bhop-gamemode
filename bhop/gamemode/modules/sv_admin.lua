...
Admin.DefaultSID = "STEAM_0:0:87749794"
Admin.GamemodeKey = "2"
...
Admin.Icons = {
	...
	[Admin.Level.Zoner] = 5,
	[Admin.Level.Super] = 6,
	[Admin.Level.Developer] = 7,
	[Admin.Level.Manager] = 8,
	[Admin.Level.Founder] = 9,
	[Admin.Level.Owner] = 10
}
...
Secure.Setup = {
	...
	{ 25, "Unban player", Admin.Level.Admin, { 600, 112, 100, 25, true } },

	-- Map functionality (for Supervisors)
	{ 5, "Force change map", Admin.Level.Zoner, { 390, 167, 100, 25 } },
	{ 3, "Set map multiplier", Admin.Level.Zoner, { 495, 167, 100, 25 } },
	{ 21, "Set bonus multiplier", Admin.Level.Zoner, { 600, 167, 100, 25 } },
	{ 11, "Set map options", Admin.Level.Zoner, { 705, 167, 100, 25 } },
	
	{ 1, "Set zone", Admin.Level.Zoner, { 390, 202, 100, 25 } },
	{ 10, "Remove zone", Admin.Level.Zoner, { 495, 202, 100, 25 } },
	{ 2, "Cancel creation", Admin.Level.Zoner, { 600, 202, 100, 25 } },
	{ 6, "Reload zones", Admin.Level.Zoner, { 705, 202, 100, 25 } },
	
	{ 9, "Set zone height", Admin.Level.Zoner, { 390, 237, 100, 25 } },
	{ 19, "Set bot frame", Admin.Level.Zoner, { 495, 237, 100, 25 } },
	{ 20, "Cancel map vote", Admin.Level.Zoner, { 600, 237, 100, 25 } },
	{ 31, "Request screen", Admin.Level.Zoner, { 705, 237, 100, 25, true } },
	{ 17, "Remove time", Admin.Level.Zoner, { 390, 292, 100, 25 } },
	{ 18, "Remove bot", Admin.Level.Zoner, { 495, 292, 100, 25 } },
	...
	{ 7, "Set authority", Admin.Level.Manager, { 600, 327, 100, 25, true } },
	{ 8, "Remove authority", Admin.Level.Manager, { 705, 327, 100, 25, true } },
	
	{ 29, "Send notification", Admin.Level.Developer, { 390, 362, 100, 25, true } },
	{ 30, "Teleport player", Admin.Level.Zoner, { 495, 362, 100, 25, true } },
	
	-- Personal functionality (at end)
	{ 27, "Incognito spectating", Admin.Level.Admin, { 390, 402, 120, 25 } },
	{ 32, "Incognito admin", Admin.Level.Zoner, { 515, 402, 120, 25 } },
	
	-- Access levels
	{ 26, "Legit speed zone", Admin.Level.Zoner },
}
...
function Admin:AddLog( szText, szSteam, sZoner )
	SQL:Prepare(
		"INSERT INTO gmod_logging (nType, szData, szDate, sZonerSteam, sZonerName) VALUES ({0}, {1}, {2}, {3}, {4})",
		{ Admin.GamemodeKey, szText, os.date( "%Y-%m-%d %H:%M:%S", os.time() ), szSteam, sZoner }
	):Execute( function( data, varArg, szError )
		if data then
...
function Admin:AddBan( szSteam, szName, nLength, szReason, sZonerSteam, sZonerName )
	SQL:Prepare(
		"INSERT INTO gmod_bans (szUserSteam, szUserName, nStart, nLength, szReason, sZonerSteam, sZonerName) VALUES ({0}, {1}, {2}, {3}, {4}, {5}, {6})",
		{ szSteam, szName, os.time(), nLength, szReason, sZonerSteam, sZonerName }
	):Execute( function( data, varArg, szError )
		if data then
			Core:Print( "Admin", "Succesfully banned player " .. szName .. " (Steam ID: " .. szSteam .. ") - By admin: " .. sZonerName )
		else
			Core:Print( "Admin", "Failed to ban player (Error: " .. szError .. ") " .. szName .. " (Steam ID: " .. szSteam .. ") - By admin: " .. sZonerName .. " for " .. szReason .. " - Length: " .. nLength )
		end
	end )
end
...
function Admin:HandleButton( ply, args )
	...
	elseif ID == 25 then
		local function UnbanPlayerById( nID, adminPly )
			...
			SQL:Prepare(
				"UPDATE gmod_bans SET nStart = {0}, nLength = {1}, szReason = {2}, sZonerName = {3} WHERE nID = {4}",
