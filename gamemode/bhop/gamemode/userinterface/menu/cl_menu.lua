...
SMPanels.EndList({
    ...
    tip = ""
		...
		local OPSize = panParent:GetWide() - Interface:GetTextWidth( { "⇩⇩⇩" }, Interface:GetFont() )
		...
		SMPanels.ButtonScroll( { parent = panParent, text = "more options ⇩⇩⇩", tip = "", func = OpenDevTools, scale = true, x = dtSize - bezel, y = bezel + (boxSize * 13) } )
	end
