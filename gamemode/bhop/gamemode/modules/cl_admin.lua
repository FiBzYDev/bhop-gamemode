...
CreateConVar("cl_drawarea_snap", "1", { FCVAR_ARCHIVE, FCVAR_CLIENTCMD_CAN_EXECUTE }, "Enable/disable snapping in draw area editor")
...
local function SnapPosition(pos)
    if GetConVar("cl_drawarea_snap"):GetBool() then
