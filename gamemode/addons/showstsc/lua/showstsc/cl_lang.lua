...
language.Add("showclips.msg.lags", "There may be some lags!")
language.Add("showclips.msg.enabled", "Player clips are enabled.")
language.Add("showclips.msg.disabled", "Player clips are now disabled!")
language.Add("showclips.msg.error", "Can't read information from the map .bsp file")
...
language.Add("showtriggers.msg.enabled", "Triggers are enabled.")
